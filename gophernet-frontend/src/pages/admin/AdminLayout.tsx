...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200">
      ...
      <aside className="w-64 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 shadow-2xl relative">
        ...
        <div className="relative p-6 border-b border-slate-700/50">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="p-2 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-lg shadow-lg group-hover:shadow-teal-500/50 transition-all duration-300 group-hover:scale-105">
        ...
        <nav className="mt-6 px-3 space-y-1">
          {navItems.map((item) => (
            ...
            >
              ...
              {!isActive(item.path) && (
                <div className="absolute inset-0 bg-gradient-to-r from-teal-500/0 via-teal-500/10 to-cyan-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
              )}
      ...
      {/* Main content - Enhanced Light Theme */}
